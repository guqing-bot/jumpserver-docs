...
<Card icon="crown" color="#eab308" horizontal>
  Try JumpServer Enterprise free for 14 days -- <a href="mailto:sales@lxware.hk">Contact us <Icon icon="send" /></a> to get started !
</Card>
