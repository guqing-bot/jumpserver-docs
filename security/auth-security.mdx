...
<ParamField path="Login CAPTCHA" type="boolean">
...
<ParamField path="Login dynamic code" type="boolean">
...
<ParamField path="Auto disable threshold (day)" type="number" required>
...
<ParamField path="Suspicious login verification" type="boolean">
  Remote login alert. 
...
<ParamField path="Global MFA" type="string">
...
<ParamField path="MFA in login page" type="boolean">
...
<ParamField path="MFA via email" type="boolean">
...
<ParamField path="Third-party login MFA" type="boolean">
...
<ParamField path="MFA verify TTL" type="number" required>
...
<ParamField path="OTP issuer name" type="string">
  Default: `JumpServer`
...
<ParamField path="OTP valid window" type="number" required>
