---
title: "Integrate CAS authentication"
---
...
<Step>
<Icon icon="xpack" /> In the **Organization** field, after authentication and creation, the user will be added to the selected organization.
</Step>
