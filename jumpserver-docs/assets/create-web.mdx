...
<Step>
In the left menu, click **<Icon icon="server" /> Assets**.
</Step>

<Step>
On the right page, click **<Icon icon="globe" /> Web** tab.
</Step>

<Step>
Above the table, click **Create**, or the <Icon icon="chevron-down" /> to its right.
</Step>
